...
const ImpactSection = () => {
  return (
    <section className='text-white py-24'>
      <main className='flex pb-24 px-12 gap-28'>
        ...
        <div className='w-7/12 ml-auto '>
          <h1 className='text-[85px] text-[#fff] font-[600] capitalize font-rale leading-[1.1] pb-5'>Your AI Partner in Uncluttering Life.</h1>  
          ...
          <ul className='flex flex-col gap-3 font-rale text-[23px] text-neutral-400 font-[300] list-disc list-inside'>
      ...
      <ParallaxBanner style={{ aspectRatio: '2 / 1', height:'120vh' }}>
        <ParallaxBannerLayer className='w-[100vw]'  image='./img-neebo-9.webp' speed={-20} />
      </ParallaxBanner>
    </section>
  )
}
