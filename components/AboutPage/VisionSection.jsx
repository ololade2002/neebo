...
const VisionSection = () => {
  return (
    <section className='px-12 pt-0 pb-24'>
          <main className='flex flex-row gap-28'>
        ...
        <div className='w-7/12 ml-auto '>
          <h1 className='text-[85px] text-[#fff] font-[600] capitalize font-rale leading-[1.1] pb-5'>Enhancing Your Experience.</h1>  
