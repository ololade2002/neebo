        ...
        <main className='relative'>
            <ParallaxBanner style={{ aspectRatio: '2 / 1', height:'100vh'  }}>
             ...
             <div className='absolute w-full lg:w-[60%] z-20 top-10 lg:top-20 pl-2 lg:pl-11'>
                <h2 className='text-[32px] xs:text-[40px] sm:text-[60px] lg:text-[80px] font-rale leading-[1.1] capitalize font-[600]  text-white'>Modern aesthetics crafted for elegance and comfort.</h2>
            </div>
            </ParallaxBanner>
        </main>
