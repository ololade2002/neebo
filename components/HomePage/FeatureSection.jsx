...
const FeatureSection = () => {
  return (
    <section className='pt-8 lg:pt-28 text-white'>
       <main className='flex flex-row items-center gap-2 lg:gap-4'>
         <div className=' w-full lg:w-3/12'>
           <Image className='rounded-md h-[40vw] lg:h-[48vh] object-cover' src={neeboHome} alt='Neebo Home'/>
         </div>
         <div className=' w-full lg:w-7/12'>
           <Image className='rounded-md h-[40vw] lg:h-[70vh] object-cover' src={neeboPlus} alt='Neebo Plus'/>
         </div>
         <div className=' w-full lg:w-3/12'>
           <Image className='rounded-md h-[40vw] lg:h-[48vh] object-cover' src={neeboPro} alt='Neebo Pro'/>
         </div>
       </main>

       <main className='px-4 lg:px-11 py-14 lg:py-32'>
        <h2 className=' text-[32px] xs:text-[45px] sm:text-[90px] lg:text-[170px] text-center leading-[1.3] md:leading-[1] font-[400] text-[#ecebe9]'>YOUR FRIENDLY AI SIDEKICK</h2>
       </main>
      ...
      <main className='px-4 lg:pl-11 lg:pr-0 pt-12 lg:pt-16 pb-16 lg:pb-32 flex flex-col lg:flex-row items-center justify-center gap-14 lg:gap-28'>
        <div className='flex flex-col w-full lg:w-[50%]' >
          ...
          <h4 className='py-5 font-rale text-[rgba(255,255,255,0.6)] text-[20px] font-[300]'>Experience the convenience of modern technology integrated seamlessly into your life. Let us handle the complexities so you can focus 
