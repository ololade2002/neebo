...
const JoinSection = () => {
  return (
    <section className='text-white px-11 py-24 h-[100vh]'>
      <main className='flex w-6/12 text-center flex-col mx-auto justify-center items-center'>
      <p className='text-neutral-400 font-mono'>JOIN NEEBO NOW</p>
        <h1 className='text-[90px] leading-[1.2] font-[500] py-16 font-rale capitalize'>Subscribe for Neebo insights</h1>
